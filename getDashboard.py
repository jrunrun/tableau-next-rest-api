...
def get_visualizations_with_requests(base_url: str, access_token: str, dashboard_api_name: str) -> dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            with open('./sample-responses/getDashboard-response.json', 'w') as f:
                json.dump(response.json(), f, indent=2)
            print("Response has been saved to getDashboard-response.json")
...
get_visualizations_with_requests("https://" + org, auth_token, dashboard_api_name)