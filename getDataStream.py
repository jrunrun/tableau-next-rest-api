...
# getDataStream
# GET
# https://{dne_cdpInstanceUrl}/services/data/v64.0/ssot/data-streams/{recordIdOrDeveloperName}
# Get a data stream.
...
version = 'v63.0'
# recordIdOrDeveloperName = 'Sample_Superstore_Orderscsv__dll'
recordIdOrDeveloperName = '1dsHo000000H0An'
# This works:
...
# Get semantic models
get_data_stream(org, auth_token, version, recordIdOrDeveloperName)
