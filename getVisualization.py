...
def get_visualizations_with_requests(base_url: str, access_token: str, visualization_api_name: str) -> dict[str, Any]:
    ...
    endpoint = f"{base_url}/services/data/v64.0/tableau/visualizations/{visualization_api_name}"
    ...
    try:
        ...
        try:
            ...
            with open('./sample-responses/getVisualization-response.json', 'w') as f:
                json.dump(response.json(), f, indent=2)
            print("Response has been saved to getVisualization-response.json")
...
get_visualizations_with_requests("https://" + org, auth_token, visualization_api_name)