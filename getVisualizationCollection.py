...
def get_visualizations_with_requests(base_url: str, access_token: str) -> dict[str, Any]:
    ...
    endpoint = f"{base_url}/services/data/v64.0/tableau/visualizations"
    ...
    try:
        ...
        try:
            ...
            with open('./sample-responses/getVisualizationCollection-response.json', 'w') as f:
                json.dump(response.json(), f, indent=2)
            print("Response has been saved to getVisualizationCollection-response.json")
